...
class CondolenceOrderReceived extends Mailable implements ShouldQueue
{
    ...
    public function envelope(): Envelope
    {
        return new Envelope(
            ...
            subject: __("mail.condolence_order_received.subject", [
    ...
    {
        return new Content(
            markdown: 'mail/partials.condolence-order-received',
        );
    }
