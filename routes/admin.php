...
Route::get('condolences-offers/{condolences_offer}/send', [CondolencesOfferController::class, 'send'])->name('condolences-offers.send');
Route::get('condolences-offers/{condolences_offer}/download', [CondolencesOfferController::class, 'download'])->name('condolences-offers.download');
