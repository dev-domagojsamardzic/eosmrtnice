        ...
        <form method="POST" action="{{ $action }}">
            ...
            <div class="row">
                <div class="col-lg-8 col-sm-12 d-flex align-items-start justify-content-end flex-column">
                    ...
                    <span>
                        {{ __('models/post.deceased_image') }}: {{ $post->image ? __('common.yes') : __('common.no') }}
                    </span>
                    <span>
                        {{ __('models/post.is_framed') }}: {{ $post->is_framed ? __('common.yes') : __('common.no') }}
                    </span>
                    <span>
                        {{ __('models/post.symbol') }}: {{ $post->symbol->translate() }}
                    </span>
                </div>
