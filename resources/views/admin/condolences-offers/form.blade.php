<x-app-layout>
    ...
    <div>
        <form method="POST" action="{{ $action }}">
            ...
            <input type="hidden" name="condolence_id" value="{{ $condolence->id }}">
            ...
            <div class="row">
                <div class="col-lg-8 col-sm-12 d-flex align-items-start justify-content-end flex-column">
                    ...
                    @endif
                    <span class="font-weight-bold">{{ __('models/condolence.message')  }}</span>
                ...
                <div class="col-lg-2 col-sm-6">
                    ...
                    <div class="input-group input-group-joined">
                        <input class="form-control"
                               ...
                               min="1"
                               step="1"
                               value="{{ old('quantity', $offer->quantity) ?? "1" }}"
                               required>
                    </div>
            ...
            <div class="row">
                <div class="col-md-6 col-sm-12">
                    <p class="font-weight-bold">{{ __('models/condolence.sender_data') }}</p>
                    <span>{{ $condolence->sender_full_name }}</span><br>
                    <span>{{ $condolence->sender_email }}</span><br>
                    <span>{{ $condolence->sender_phone }}</span><br>
                    <span>{!! $condolence->sender_address !!}</span><br>
                    <span>{!! $condolence->sender_additional_info !!}</span><br>
                </div>
                <div class="col-md-6 col-sm-12">
                    <p class="font-weight-bold">{{ __('models/condolence.recipient_data') }}</p>
                    <span>{{ $condolence->recipient_full_name }}</span><br>
                    <span>{!! $condolence->recipient_address !!}</span><br>
                </div>
            </div>
