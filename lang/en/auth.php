...
return [
    ...
    */
    ...
    'labels' => [
        ...
        'company_zipcode' => 'ZipCode (required)',
        'company_county' => 'County (required)',
        'company_oib' => 'OIB (required)',
        'company_email' => 'Email',
    ...
    'placeholders' => [
        ...
        'company_title' => 'Enter Company Name',
        'company_address' => 'Enter Company Address',
        'company_town' => 'Where is the Company?',
        'company_zipcode' => 'Enter ZipCode',
        'company_oib' => 'Enter OIB',
    ...
    'forgot_password_text' => 'No problem. Just let us know your email address and we will email you a password reset link that will allow you to choose a new one.',
