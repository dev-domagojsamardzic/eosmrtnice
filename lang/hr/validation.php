...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'message' => 'poruka',
        'recipient_full_name' => 'ime i prezime primatelja',
        'recipient_address' => 'adresa primatelja',
        'recipient_zipcode' => 'poštanski broj primatelja',
        'recipient_town' => 'grad ili mjesto primatelja',
        'sender_full_name' => 'ime i prezime ili naziv tvrtke naručitelja',
